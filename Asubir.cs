...
public class Form1 : Form // creamos una clase que hereda de windows forms, asi que podemos usar sus propiedades y eso
{
	...
	public Form1() // creamos el metodo Form1() o el formulario
	{
		...
		panel1.BorderStyle = BorderStyle.Fixed3D; // es necesario ponerle borde, para que podamos realmente observarlo si no estará presente pero no nos daremos cuenta en donde esta puesto
